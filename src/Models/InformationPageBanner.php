...
Class InformationPageBanner extends Model
{
  ...
  {
    return $this->belongsTo( InformationPage::class, 'information_page_id' )->withDefault();
  }

  public function blocks()
  {
    return $this->hasMany( InformationPageBannerBlock::class, 'information_page_banner_id' );
  }
